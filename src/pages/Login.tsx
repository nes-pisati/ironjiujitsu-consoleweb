                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <form className="space-y-4 md:space-y-6 flex flex-col" action="#" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="username" id="username" className="border border-zinc-600 text-white rounded-lg block w-full p-2.5 bg-zinc-700 placeholder-gray-400 focus:outline-none" onChange={onChangeInput} />
                                </div>
                                <div>
                                    <label className="block mb-2 text-sm font-medium text-white">Password</label>
                                    <input type="password" name="password" id="password" className="border border-zinc-600 text-white rounded-lg block w-full p-2.5 bg-zinc-700 placeholder-gray-400 focus:outline-none" onChange={onChangeInput} />
                                </div>
